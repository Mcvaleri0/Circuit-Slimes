...
Shader "BoardSelection"
{
	...
	SubShader
	{
		...
		{
			float3 temp_cast_0 = (_Color0.a).xxx;
			...
			float2 appendResult10_g16 = (float2(temp_output_37_0 , temp_output_37_0));
			float2 temp_output_11_0_g16 = ( abs( (i.uv_texcoord*2.0 + -1.0) ) - appendResult10_g16 );
			float2 break16_g16 = ( 1.0 - ( temp_output_11_0_g16 / fwidth( temp_output_11_0_g16 ) ) );
			o.Alpha = ( ( ( saturate( ( ( tex2D( _TextureSample0, uv_TextureSample0 ) + _Bias ) * _Scale ) ) * ( 1.0 - saturate( min( break16_g15.x , break16_g15.y ) ) ) * _GridOpacity ) + ( saturate( min( break16_g17.x , break16_g17.y ) ) - saturate( min( break16_g16.x , break16_g16.y ) ) ) ) * _GlobalOpacity ).r;
		}
...
/*ASEBEGIN
Version=18000
-4.8;108;1523;619;1796.297;226.0813;1.667147;True;False
...
Node;AmplifyShaderEditor.FunctionNode;36;-983.2033,548.5385;Inherit;False;Rectangle;-1;;16;6b23e0c975270fb4084c354b2c83366a;0;3;1;FLOAT2;0,0;False;2;FLOAT;0.5;False;3;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-310.869,469.119;Inherit;False;Property;_GlobalOpacity;GlobalOpacity;5;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;14;-152.6643,-102.5148;Inherit;False;Property;_Color0;Color 0;0;0;Create;True;0;0;False;0;0,1,1,0;0,1,0.4333334,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;0;2;14;4
WireConnection;0;9;59;0
ASEEND*/
//CHKSM=E51DE3332A7A2216FEC5D1D9B9B306FF169F50FF